...
//		audioTrack = new AudioTrack(streamType, sampleRateInHz, channelConfig, audioFormat, bufferSizeInBytes, mode);
		audioTrack = new AudioTrack(streamType, sampleRateInHz, AudioFormat.CHANNEL_CONFIGURATION_STEREO, audioFormat, bufferSizeInBytes, mode);
					...
					if ( ! frameQueue.isEmpty() ) {
						...
						if (gapFrames < -packetSizeFrames) {
							...
							if (lineMuted) {
								...
								Log.i("TEST","getVolume()："+getVolume()+"getRequestedVolume()："+getRequestedVolume());
								applyVolume();
							}
...
//		Log.i("TEST","0setStereoVolume() leftVolume: " + leftVolume + " rightVolume: " + rightVolume,new Exception());
...
//			leftVolume = AudioTrack.getMaxVolume();
//		}
//		Log.i("TEST","01setStereoVolume() leftVolume: " + leftVolume + " rightVolume: " + rightVolume);
...
//		}
//
//		LOG.info("1setStereoVolume() leftVolume: " + leftVolume + " rightVolume: " + rightVolume);
//		Log.i("TEST","setStereoVolume() leftVolume: " + leftVolume + " rightVolume: " + rightVolume);
//		/*zhp add begin*/
//		if(leftVolume==-144.0f){
//			leftVolume=0.0f;
//			rightVolume=0.0f;
//			audioTrack.setStereoVolume(leftVolume, rightVolume);
//			return;
//		}
//		leftVolume =leftVolume +30;
//		leftVolume =(float) (leftVolume /1.875*0.0625);
//		rightVolume=leftVolume;
//		/*zhp add end*/
//		Log.i("TEST","03setStereoVolume() leftVolume: " + leftVolume + " rightVolume: " + rightVolume);
//		audioTrack.setStereoVolume(leftVolume, rightVolume);
//	}
	 ...
	 */
	private void setStereoVolume(float leftVolume, float rightVolume) {
		leftVolume = getRequestedVolume();
		Log.i("TEST","leftVolume: " + leftVolume+"max:"+AudioTrack.getMaxVolume());
		if(leftVolume==-144.0f){
			leftVolume=0.0f;
			rightVolume=0.0f;
			audioTrack.setStereoVolume(leftVolume, rightVolume);
		...
		leftVolume =leftVolume +144.0f;
		Log.i("TEST","2leftVolume: " + leftVolume);
		leftVolume =(float) (leftVolume /10);
		rightVolume=leftVolume;
		Log.i("TEST","3leftVolume: " + leftVolume);
		/*zhp add end*/
		audioTrack.setStereoVolume(1, 1);
//		AudioManager mAudioManager = (AudioManager) .getSystemService(Context.AUDIO_SERVICE);
//		mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, (int) (mVolumeVaule / scale), 0);
	}
